...
/**
 * Test case for class Tx_Mn_personalize_Controller_PersonalizeFilterController.
 *
 * @version $Id$
 ...
 */
class Tx_Mn_personalize_Controller_PersonalizeFilterControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
