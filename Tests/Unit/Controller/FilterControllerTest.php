...
/**
 * Test case for class Tx_Mn_personalize_Controller_FilterController.
 *
 * @version $Id$
 ...
 */
class Tx_Mn_personalize_Controller_FilterControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
