...
/**
 * Test case for class Tx_MnPersonalize_Domain_Model_FilterProperty.
 *
 * @version $Id$
 ...
 */
class Tx_MnPersonalize_Domain_Model_FilterPropertyTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
